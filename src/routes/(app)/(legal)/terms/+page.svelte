...
<section class="container grid items-center gap-6">
	<div class="flex max-w-[980px] flex-col items-start gap-2">
		...
		<h4 class="mt-3 text-lg font-medium leading-tight tracking-tighter md:text-xl">Termination</h4>
		<p class="max-w-[700px] text-lg text-muted-foreground">
		...
		<h4 class="mt-3 text-lg font-medium leading-tight tracking-tighter md:text-xl">Contact Us</h4>
		<p class="max-w-[700px] text-lg text-muted-foreground">
